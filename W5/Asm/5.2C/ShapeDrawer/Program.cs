    ...
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            do
            {
                ...
                {
                    myShape.Save("/Users/ngathi/Desktop/TestDrawing.txt"); //bin/debug/net6.0
                }
                
                if (SplashKit.KeyTyped(KeyCode.OKey))   //open (load) the test drawing file
                {
                    try
                    {
                        myShape.Load("/Users/ngathi/Desktop/TestDrawing.txt");
                    }
                    catch (Exception e)
                    {
